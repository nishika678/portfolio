...
function Contact() {
    ...
    const formCon=useRef(null)

    const [error,setError]=useState(false)
    const [success,setSuccess]=useState(false)


    const Viewis=useInView(a,{margin:"-100px"})

    const EmailSend = (e) => {
        e.preventDefault();
    
        emailjs
          .sendForm('service_2ndcum4', 'template_14ceith', formCon.current, {
            publicKey: 'JZGoCNy-dwiXc88W_',
          })
          .then(
            (result) => {
                setSuccess(true);
    ...
    <motion.div className="contact" variants={con} initial="initial" whileInView="animate">
        ...
        <div className="form1">
            ...
            transition={{delay:4,duration:1}}>
                ...
                <textarea rows={8} placeholder="Message" name="from_message"/>
